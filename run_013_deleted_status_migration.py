#!/usr/bin/env python3
"""
Run migration to add 'deleted' status to task_status enum.
"""

import psycopg2

DATABASE_URL = "postgresql://postgres:ItAxQqfRlFJlScRpgzPGswYNKMvzCuTg@gondola.proxy.rlwy.net:13404/railway"
